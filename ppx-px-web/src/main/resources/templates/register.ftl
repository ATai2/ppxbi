        ...
        <div class="rule-title">
            ...
            <div class="rule-nr">
                ...
                <p
                        style="margin-top: 0px; margin-bottom: 0px; white-space: normal; padding: 0px; color: #666666; font-family: 'Microsoft YaHei', 'Hiragino Sans GB'; font-size: 14px; line-height: 20px; background-color: #FFFFFF;">
                <h4
                        style="box-sizing: border-box; margin: 0px; padding: 0px; font-weight: normal; font-size: 14px; color: #333333; text-align: justify; white-space: normal;   line-height: 20px; background-color: #FFFFFF;">
                    云EC用户注册协议aaaaaaaaaaaaaa</h4>
                <p
                        style="box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; text-align: justify; white-space: normal; color: #666666;   font-size: 14px; line-height: 20px; background-color: #FFFFFF;">
                    本协议是您与云EC网站（简称"本站"，网址：www.yunec.cn）所有者（以下简称为"云EC"）之间就云EC网站服务等相关事宜所订立的契约，请您仔细阅读本注册协议，您点击"同意并继续"按钮后，本协议即构成对双方有约束力的法律文件。
                </p>
                <h5
                        style="box-sizing: border-box; margin: 10px 0px; padding: 0px; font-weight: normal; font-size: 14px; color: #333333; text-align: justify; white-space: normal;   line-height: 20px; background-color: #FFFFFF;">
                    第1条 本站服务条款的确认和接纳</h5>
                <p
                        style="box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; text-align: justify; white-space: normal; color: #666666;   font-size: 14px; line-height: 20px; background-color: #FFFFFF;">
